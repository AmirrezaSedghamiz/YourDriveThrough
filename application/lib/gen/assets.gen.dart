...
class $AssetsOnBoardingImagesGen {
  ...
  /// File path: assets/OnBoardingImages/Page1.png
  AssetGenImage get page1 =>
      const AssetGenImage('assets/OnBoardingImages/Page1.png');

  /// File path: assets/OnBoardingImages/Page2.png
  AssetGenImage get page2 =>
      const AssetGenImage('assets/OnBoardingImages/Page2.png');

  /// File path: assets/OnBoardingImages/Page3.png
